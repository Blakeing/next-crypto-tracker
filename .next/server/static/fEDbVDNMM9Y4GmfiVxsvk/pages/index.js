...
function (_React$Component) {
  ...
  function Prices() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf_getPrototypeOf(Prices)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Prices, [{
    ...
    value: function render() {
      ...
      }, "Bitcoin rate for ", this.props.bpi[this.state.currency].description, " :", external_react_default.a.createElement("span", {
        className: "badge badge-primary"
      }, this.props.bpi[this.state.currency].code), external_react_default.a.createElement("strong", null, this.props.bpi[this.state.currency].rate))), external_react_default.a.createElement("br", null), external_react_default.a.createElement("select", {
